...
Page({
  ...
  getCartList: function() {
    ...
    util.request(api.CartList).then(function(res) {
      if (res.errcode === '0') {
        ...
        var goodCount = res.data.cartTotal.goodsCount
  ...
  cutNumber: function(event) {
    ...
    this.refreshProductNumber(cartItem, -1)
  },
  ...
  refreshProductNumber: function(cartItem, number){
    var checkedGoodsAmount = 0

    if(cartItem.checked){
      checkedGoodsAmount = cartItem.price
    }
    this.setData({
      'cartTotal.checkedGoodsAmount': this.data.cartTotal.checkedGoodsAmount + checkedGoodsAmount * number,
  ...
  refreshCartNumber: function(){
    var goodCount = this.data.cartTotal.checkedGoodsCount
    if(goodCount == null || goodCount == 0){
      wx.hideTabBarRedDot({
        index: 1
      })
